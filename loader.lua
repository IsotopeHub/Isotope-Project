...
local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      ...
      Invite = "https://discord.gg/zM7a4nENPr", -- The Discord invite code, do not include Discord.gg/. E.g. Discord.gg/ABCD would be ABCD
   ...
   KeySettings = {
      ...
      Subtitle = "Get key to use Isotope Hub",
      Note = "Link: https://direct-link.net/5245958/D6WFCxoJAP9a", -- Use this to tell the user how to get a key
